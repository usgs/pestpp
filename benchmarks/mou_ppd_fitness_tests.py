...
def ppd_fitness_sklearn(ppd_beta = 0.5, master_dir = "master"):
...
def ppd_part2_test():
    parsum1 = ppd_fitness_sklearn(ppd_beta = 0.5, master_dir = "master1")
    parsum2 = ppd_fitness_sklearn(ppd_beta = 0.8, master_dir = "master2")
