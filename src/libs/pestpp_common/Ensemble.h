...
public:
	...
	Eigen::MatrixXd get_eigen_mean_diff(string on_real="");
	Eigen::MatrixXd get_eigen_mean_diff(const vector<string> &_real_names, const vector<string> &_var_names, string on_real="");
