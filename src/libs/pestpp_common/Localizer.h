...
public:
	...
	unordered_map<string, pair<vector<string>, vector<string>>> get_localanalysis_case_map(int iter, ObservationEnsemble &oe, ParameterEnsemble &pe, PerformanceLog *performance_log);// { return localizer_map; }
