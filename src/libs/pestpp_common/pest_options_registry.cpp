...
const std::vector<OptionSpec>& PestppOptions::get_option_registry()
{
    ...
    OptionSpec{ "PANTHER_MASTER_TIMEOUT_MILLISECONDS", {}, OptType::INT, "panther", false,
    ...
    OptionSpec{ "PANTHER_MASTER_ECHO_INTERVAL_MILLISECONDS", {}, OptType::INT, "panther", false,
    ...
    OptionSpec{ "PANTHER_PERSISTENT_WORKERS", {}, OptType::BOOL, "panther", false,
    ...
    OptionSpec{ "PANTHER_PING_INTERVAL_SECS", {}, OptType::INT, "panther", false,
