...
void glm_upgrade_thread_function(int id, int iter, double cur_lam, 
GlmLocalAnalysisUpgradeThread& worker, exception_ptr& eptr)
{
	try
	{
...
void GlmLocalAnalysisUpgradeThread::work(int thread_id, int iter, double cur_lam)
{
	class local_utils
	{
	public:
